                            ...
                            <div className="col-span-1 md:col-span-3 lg:col-span-3 flex justify-center items-center">
                                <Link href="./productions">
                                    <Button 
                                        size="lg" 
                                        radius="full" 
                                        className="bg-gradient-to-tr from-[#03a07d] to-[#006400] hover:from-[#029d70] hover:to-[#005700] text-white shadow-lg transition-all duration-300 font-semibold  ease-in-out lg:mb-8"
                                    >
                                        Listen Now
